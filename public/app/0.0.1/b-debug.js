 ...
 * Time: 5:33 PM
 */
define("#app/0.0.1/lib/util/core/ajax-debug", ["#jquery/1.8.1/jquery-debug"], function(require, exports, module) {
    var $ = require('#jquery/1.8.1/jquery-debug');
    return {
 ...
 * Time: 5:38 PM
 */
define("#app/0.0.1/b-debug", ["./lib/cmp/core/mask-debug", "./lib/util/core/position-debug", "./lib/cmp/core/win-debug", "./lib/util/core/ajax-debug", "#jquery/1.8.1/jquery-debug"], function(require, exports, module) {
    var $ = require('#jquery/1.8.1/jquery-debug');
